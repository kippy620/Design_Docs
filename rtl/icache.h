...
//------------------------------------------------------------------------------
	...
	// state of L2_icache
	`define L2_IDLE	 			 2'h0  // free
	`define WRITE_L1	 		 2'h1  // write block to L1_icache
	`define ACCESS_L2	 		 2'h2  // access L2_icache
	`define WRITE_L2			 2'h4  // write block to L2_icache
`endif